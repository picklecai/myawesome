...
[正则表达式的基础教程(包含在线练习题) - 后端 - 掘金](https://juejin.im/entry/59a651116fb9a024844938b5)

余晟自己写的：[正则表达式（四）：正则表达式的与或非-InfoQ](https://www.infoq.cn/article/2011/04/regular-expressions-4)

[练完这篇就会写正则 - 掘金](https://juejin.im/post/5d89edb1518825097619ecfe)

练习题：正则闯关——[Regex Golf](https://alf.nu/RegexGolf)
